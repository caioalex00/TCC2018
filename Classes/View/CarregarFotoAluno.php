 ...
 * pelo pacote Jcrop de corte de imagens, todo esse código trabalha somente com a foto de perfil do aluno.
...
if(isset($_REQUEST['Cadastrar-A'])){
   ...
   //Apagando foto anterior e salvando a imagem nova de 500px de largura:
   unlink($filename);
   imagejpeg($image_p, $filename, 75);
}
?>
    ...
    <body>
        ...
        <main class="Principal-Conteudo" style="padding-bottom: 50px;">
            ...
            <form action="../Controller/CadastrarUsuario.php" method="post" onsubmit="return checkCoords();">
                ...
                <center><button name="Cadastrar-A" type="submit" class="btn btn-cadastro" style="width: 500px" value="Crop Image">Finalizar o cadastro</button></center>
            </form>
            <?php } ?>
