            ...
            <section class="container">
                ...
                <div class="collapse navbar-collapse" id="MenuPaginaPrincipal">
                    ...
                    <ul class="navbar-nav ml-auto Persona-Link Persona-Link-Cor1">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link Persona-Link-Cor2">Cadastro</a>
                        </li>

                        <li class="nav-item">
                            <a href="" class="nav-link Persona-Link-Cor2">Login</a>
                        </li>
            ...
            <section class="Funcionalidades-Grupos row">
                ...
                <div class="card col-md-4 persona-card-inicio">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text texto-card-persona lead">Um ambiente virtual de aprendizagem (AVA) vem integrado ao nosso website, nele é possivel realizar um curso de introdução a Língua Brasileira de Sinais (LIBRAS), a libras é a segunda língua oficial do Brasil, sendo usada para comunicação pela comunidade surda. </p>
                    </div>
                </div>
        ...
        <section id="Apresentacao-AVA">
            ...
            <section class=" container Apresentacao-AVA-Fotos row">
                <figure class="col-md-4">
                    <img src="imgs/AVA-Foto-1.png" alt=""/>
                </figure>
                <figure class="col-md-4">
                    <img src="imgs/AVA-Foto-2.png" alt=""/>
                </figure>
                <figure class="col-md-4">
                    <img src="imgs/AVA-Foto-3.png" alt=""/>
                </figure>
            </section>
